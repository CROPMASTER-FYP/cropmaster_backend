"""
Django settings for cropmaster project.
...
SECRET_KEY = "django-insecure-^yc^tq5*d30oz%q6@ia%czc#7b7l!1$3)6*8rclv8*c*9136=$"
...
WSGI_APPLICATION = "cropmaster.wsgi.application"
